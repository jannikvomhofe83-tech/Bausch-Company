        ...
        <div className="mb-12 md:mb-18 lg:mb-20">
          <div className="mx-auto w-full max-w-lg text-center">
            ...
            <p className="md:text-md">
              Ausgewählte Beiträge zu Nachfolge, Führung und Wandel
            </p>
          </div>
        </div>
        <div className="grid grid-cols-1 gap-x-8 gap-y-12 md:grid-cols-2 md:gap-y-16 lg:grid-cols-3">
            ...
            <div className="px-5 py-6 md:p-6">
              ...
              <a className="mb-2 block max-w-full" href="#">
                <h2 className="text-xl font-bold md:text-2xl">
                  Wenn die zweite Generation übernimmt
                </h2>
              </a>
              <p>
                Übergaben scheitern nicht an der Wahl, sondern an mangelnder
                Vorbereitung.
              </p>
              <Button
                title="Lesen"
          ...
          <div className="flex size-full flex-col items-center justify-start border border-border-primary">
            ...
            <div className="px-5 py-6 md:p-6">
              <div className="rb-4 mb-4 flex w-full items-center justify-start">
                ...
                <p className="inline text-sm font-semibold">6 Minuten</p>
              </div>
              <a className="mb-2 block max-w-full" href="#">
                <h2 className="text-xl font-bold md:text-2xl">
                  Die richtige Person für die Rolle finden
                </h2>
              </a>
              <p>
                Kompetenz allein reicht nicht. Es geht um kulturelle Passung.
              </p>
              <Button
                title="Lesen"
                variant="link"
          ...
          <div className="flex size-full flex-col items-center justify-start border border-border-primary">
            ...
            <div className="px-5 py-6 md:p-6">
              ...
              <p>
                Technologie ist ein Werkzeug. Die Kultur entscheidet über den
                Erfolg.
              </p>
              <Button
                title="Lesen"
