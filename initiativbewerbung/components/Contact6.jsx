    ...
    <section id="relume" className="px-[5%] py-16 md:py-24 lg:py-28">
      <div className="container grid grid-cols-1 items-start gap-y-12 md:grid-flow-row md:grid-cols-2 md:gap-x-12 lg:grid-flow-col lg:gap-x-20 lg:gap-y-16">
        <div>
          <div className="mb-6 md:mb-8">
            ...
            <p className="md:text-md">
              Teilen Sie uns mit, welche Rolle Sie reizt und warum
              Familienunternehmen Sie interessieren.
            </p>
          </div>
          <div className="grid grid-cols-1 gap-4 py-2">
            ...
            <div className="flex items-center gap-4">
              ...
              <p>Ballindamm 39, 20095 Hamburg, Deutschland</p>
            </div>
          </div>
        </div>
        <form className="grid max-w-lg grid-cols-1 grid-rows-[auto_auto] gap-6">
          ...
          <div className="grid w-full items-center">
            <Label className="mb-2">Gesuchte Position</Label>
            <Select>
              <SelectTrigger>
          ...
          <div className="grid w-full items-center py-3 md:py-4">
            <Label className="mb-3 md:mb-4">
              Welche Rolle interessiert Sie?
            </Label>
            <RadioGroup className="grid grid-cols-2 gap-x-6 gap-y-3.5">
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="Geschäftsführung" id="#first_choice" />
                <Label htmlFor="#first_choice">Geschäftsführung</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="First choice" id="#second_choice" />
                <Label htmlFor="#second_choice">Finanzleitung</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="First choice" id="#third_choice" />
                <Label htmlFor="#third_choice">Betriebsleitung</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="First choice" id="#fourth_choice" />
                <Label htmlFor="#fourth_choice">Beiratsmitgliedschaft</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="First choice" id="#fifth_choice" />
                <Label htmlFor="#fifth_choice">Transformationsleitung</Label>
              </div>
              <div className="flex items-center space-x-2">
          ...
          <div className="grid w-full items-center">
            ...
            <Textarea
              id="message"
              placeholder="Erzählen Sie uns von Ihren Erfahrungen und Erwartungen..."
