        ...
        <div className="rb-12 mb-12 md:mb-18 lg:mb-20">
          <div className="mx-auto max-w-lg text-center">
            ...
            <p className="md:text-md">
              Im Dienstleistungssektor kennen wir die besonderen Anforderungen
            </p>
          </div>
        </div>
            ...
            <div className="grid grid-cols-1 border border-border-primary sm:col-span-2 sm:row-span-1">
              <div className="flex flex-1 flex-col justify-center p-6 md:p-8 lg:p-12">
                <div>
                  ...
                  <p>
                    Vertrauliche Suche nach Führungskräften ohne Marktsignale
                  </p>
                </div>
                <div className="mt-6 flex flex-wrap items-center gap-4 md:mt-8">
                  <Button title="Erfahren" variant="secondary">
                    Erfahren
                  </Button>
                  <Button
                    title="Mehr"
              ...
              <div className="flex h-full flex-col justify-between p-6 md:p-8 lg:p-6">
                <div>
                  ...
                  <h3 className="mb-2 text-xl font-bold md:text-2xl">
                    Familiendynamische Moderation
                  </h3>
                  <p>
                    Klare Rollen und Erwartungen zwischen Familie und
                    Unternehmen
                  </p>
                </div>
