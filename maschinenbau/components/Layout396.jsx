      ...
      <div className="container">
        <div className="mx-auto mb-12 w-full max-w-lg text-center md:mb-18 lg:mb-20">
          ...
          <h1 className="mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
            Typische Positionen im Maschinenbau
          </h1>
          <p className="md:text-md">Diese Profile suchen wir regelmäßig</p>
        </div>
        <div className="grid auto-cols-fr grid-cols-1 gap-6 md:gap-8 lg:grid-cols-3">
          <div className="flex flex-col justify-center border border-border-primary p-6 md:p-8">
            <div>
              ...
              <p>
                Strategische Leitung mit Erfahrung in Digitalisierung und
                internationalen Märkten gefragt.
              </p>
            </div>
          ...
          <div className="flex flex-col justify-center border border-border-primary p-6 md:p-8">
            <div>
              ...
              <p>
                Brücke zwischen Konstruktion und Geschäftsführung, mit
