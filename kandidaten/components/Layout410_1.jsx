      ...
      <div className="container">
        <div className="mx-auto mb-12 w-full max-w-lg text-center md:mb-18 lg:mb-20">
          ...
          <h1 className="mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
            Vier Gründe für Familienunternehmen
          </h1>
          <p className="md:text-md">
            Führungspositionen im Mittelstand bieten mehr als Karriere
          </p>
        </div>
        <div className="relative grid auto-cols-fr grid-cols-1 gap-6 md:gap-0">
          ...
          >
            <div className="order-first flex flex-col justify-center p-6 md:p-8 lg:p-12 md:order-last">
              <p className="mb-2 font-semibold">Gestaltung</p>
              <h2 className="mb-5 text-4xl font-bold leading-[1.2] md:mb-6 md:text-5xl lg:text-6xl">
                Sie gestalten, nicht verwalten
              </h2>
              <p>
                Hier haben Ihre Entscheidungen Gewicht. Keine Konzernbürokratie,
                keine Gremienflut – Sie sehen unmittelbar, was Ihre Arbeit
                bewirkt.
              </p>
