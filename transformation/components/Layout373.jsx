      ...
      <div className="container">
        <div className="rb-12 mb-12 md:mb-18 lg:mb-20">
          <div className="mx-auto max-w-lg text-center">
            ...
            <p className="md:text-md">Drei Geschichten aus dem Mittelstand</p>
          </div>
        </div>
              ...
              <div className="flex flex-1 flex-col justify-center p-6 md:p-8 lg:p-12">
                <div>
                  ...
                  <h3 className="mb-5 text-4xl font-bold leading-[1.2] md:mb-6 md:text-5xl lg:text-6xl">
                    Maschinenbauer, 280 Millionen Euro Umsatz
                  </h3>
                  <p>
                    Wachstum erforderte neue Ebenen. Alte Strukturen hielten
                    nicht mehr.
                  </p>
                </div>
                <div className="mt-6 flex flex-wrap items-center gap-4 md:mt-8">
                  <Button title="Fallstudie" variant="secondary">
                    Fallstudie
                  </Button>
                  <Button
                    title="Mehr"
              ...
              <div className="flex h-full flex-col justify-between p-6 md:p-8 lg:p-6">
                <div>
                  ...
                  <h3 className="mb-2 text-xl font-bold md:text-2xl">
                    Handelsunternehmen, Generationswechsel in Sicht
                  </h3>
                  <p>
                    Digitalisierung war nicht optional. Es war Überlebensfrage.
                  </p>
                </div>
