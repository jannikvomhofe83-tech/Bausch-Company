    ...
    <section style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          Wir verstehen Handel nicht als Branche, sondern als Kultur.
          Unsere Kandidaten kennen diese Welt aus eigener Erfahrung — aus
          dem Einkauf, aus dem Vertrieb, aus operativer Filial- und
          E-Commerce-Verantwortung. Das macht den Unterschied, wenn es
          darum geht, die richtige Person für eine spezifische Situation zu finden.
        </p>
        <p style={{
          fontFamily: serif,
          fontSize: "clamp(14px, 1.1vw, 18px)",
