      ...
      <div className="container">
        <div className="mx-auto mb-12 max-w-lg text-center md:mb-18 lg:mb-20">
          ...
          <h1 className="mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
            Beratung für Logistikunternehmen
          </h1>
          <p className="md:text-md">
            Wir verstehen die Logistik nicht als Kostenfaktor, sondern als
            strategisches Rückgrat. Unsere Erfahrung mit internationalen
            Netzwerken und komplexen Lieferketten hilft uns, die richtigen
            Führungskräfte zu identifizieren.
          </p>
            ...
            >
              ...
              >
                <p className="mt-3 md:mt-4">
                  Wir kennen die Anforderungen von Supply-Chain-Management,
                  Disposition und Betriebsleitung. Das macht uns schneller und
                  präziser bei der Besetzung.
                </p>
              </motion.div>
            </div>
            <div
